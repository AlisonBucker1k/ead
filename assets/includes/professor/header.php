...
<head>
      ...
      <!-- Quill Theme -->
      <link type="text/css"
              href="<?php echo site_url('assets/assetsAlison'); ?>/css/quill.css"
              rel="stylesheet">
      ...
      <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
            <div class="mdk-drawer-layout__content page-content">
                  ...
                  <div class="navbar navbar-expand pr-0 navbar-light border-bottom-2" id="default-navbar" data-primary>
                        ...
                        <a href="<?php echo site_url('professor/index'); ?>" class="navbar-brand mr-16pt d-lg-none">
                        ...
                        <div class="nav navbar-nav flex-nowrap d-flex mr-16pt">
                              ...
                              <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                          ...
                                          <a class="dropdown-item" href="<?php echo site_url('professor/perfil'); ?>">Editar Conta</a>
                                          <a class="dropdown-item" href="<?php echo site_url('professor/login/logoff'); ?>">Sair</a>
                                    </div>
                              </div>
                        </div>
