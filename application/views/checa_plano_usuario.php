...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.14/dist/css/bootstrap-select.min.css">
  ...
  <body>
    ...
    <main>
        <div class="container">
            <h3>CHECAR VOUCHER / PLANO USUÁRIO</h3><br/>
        <form method="post" action="<?php echo site_url('api/busca_plano_voucher_us'); ?>">
            ...
            <div class="form-group">
              ...
              <button type="submit" class="btn btn-block btn-danger">Checar Voucher / Plano do Usuário</button>
        </form>
        </div>
    </main><!-- /.container -->
