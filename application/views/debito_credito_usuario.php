...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.14/dist/css/bootstrap-select.min.css">
  ...
  <body>
    ...
    <main>
        <div class="container">
            <h3>DÉBITO / CRÉDITO USUÁRIO</h3><br/>
        <form method="post" action="<?php echo site_url('api/debito_credito'); ?>">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <label for="exampleInputEmail2">Operação</label>
              ...
              <div class="form-group">
                ...
                <input type="number" name="valor" step="0.01" class="form-control" min="1" />
              </div>
              <button type="submit" class="btn btn-block btn-danger">ADCIONAR DÉBITO / CRÉDITO</button>
        </form>
        </div>
    </main><!-- /.container -->
