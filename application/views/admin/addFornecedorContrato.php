    ...
    <div class="col-lg-10 p-0 mx-auto">
        <div class="row">
            <div class="col-md-6 mb-24pt mb-md-0">
                <form action="<?php echo base_url(); ?>admin/fornecedores/cadastrarContrato" enctype="multipart/form-data" method="POST">
                    
                    

                    <div class="form-group">
                        <label class="form-label" for="foto">Arquivo Contrato:</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="contrato" id="capa" type="file" class="form-control" placeholder="Capa">
            ...
            <div class="col-md-6">
                <div class="card mb-0">
                    <div class="card-body">
                        <h5>Cadastrar Contrato de Fornecedor</h5>
                            ...
                            <div class="d-flex flex-wrap align-items-start">
                                ...
                                <div class="flex" style="min-width: 180px">
                                    <small class="text-100">
                                        Faça upload do arquivo do contrato ao lado, para adicionar um contrato ou atualizar um já existente.
                                    </small>
                                </div>
                            </div>
                        </div>
