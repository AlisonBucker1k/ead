...
<div class="page-section container page__container">
    <div class="col-lg-10 p-0 mx-auto">
        <form action="<?php echo base_url('admin/fornecedores/update/'.$fornecedor[0]['id']); ?>" enctype="multipart/form-data" method="POST">
            <div class="row">
                ...
                <div class="col-md-6 mb-24pt mb-md-0">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 col-12">
                            ...
                            <input id="cadastro_no_fornecedor" type="text" class="form-control" value="<?php echo $fornecedor[0]['cadastro_no_fornecedor']; ?>" placeholder="Cadastro no Fornecedor" name="cadastro_no_fornecedor" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row pt-3">
                        <div class="col-md-12 col-12">
                            ...
                            <input id="empresa" type="text" class="form-control" value="<?php echo $fornecedor[0]['empresa']; ?>" placeholder="Empresa ou Pessoa" name="empresa" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row pt-3">
                        <div class="col-12">
                            ...
                            <input id="atividade" type="text" class="form-control" value="<?php echo $fornecedor[0]['atividade']; ?>" placeholder="Atividade do Fornecedor" name="atividade" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row pt-3">
                        <div class="col-6">
                            ...
                            <input id="contato" type="telefone" class="form-control telefone" value="<?php echo $fornecedor[0]['contato']; ?>" placeholder="(XX) XXXXX-XXXX" name="contato">
                        </div>
                        <div class="col-6">
                            <label class="form-label" for="name">Nextel: *</label>
                            <input id="nextel" type="telefone" class="form-control telefone" value="<?php echo $fornecedor[0]['nextel']; ?>" placeholder="(XX) XXXXX-XXXX" name="nextel">
                        </div>
                    </div>
                    ...
                    <div class="form-row pt-3">
                        <div class="col-6">
                            ...
                            <input id="telefone" type="telefone" class="form-control telefone" value="<?php echo $fornecedor[0]['telefone']; ?>" placeholder="(XX) XXXX-XXXX" name="telefone">
                        </div>
                        <div class="col-6">
                            <label class="form-label" for="name">Celular: *</label>
                            <input id="celular" type="telefone" class="form-control telefone" value="<?php echo $fornecedor[0]['celular']; ?>" placeholder="(XX) XXXXX-XXXX" name="celular">
                        </div>
                    </div>
                    ...
                    <div class="form-row pt-3">
                        <div class="col-12">
                            ...
                            <input name="endereco" id="endereco" type="text" class="form-control" value="<?php echo $fornecedor[0]['endereco']; ?>" placeholder="Rua, avenida..., Nº" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row pt-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <input type="cep" id="cep" name="cep" class="form-control cep" value="<?php echo $fornecedor[0]['cep']; ?>" placeholder="XXXXX-XXX" aria-describedby="basic-addon2" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="estado" onchange="getCidades($(this).val(), '#cidade')" class="form-control selectpicker" title="UF" name="estado" data-live-search="true" data-size="5" required>
                                <?php foreach ($estados as $estd) {
                                    $selected = $estd['nome'] == $fornecedor[0]['estado'] ? "selected" : "";
                                    $estadoId = $estd['nome'] == $fornecedor[0]['estado'] ? $estd['id'] : $estadoId;
                        ...
                        <div class="col-12">
                            ...
                            <select id="cidade" class="form-control selectpicker" name="cidade" data-live-search="true" title="Selecione uma cidade..." data-size="5" required>
                                <?php foreach($cidades as $cid){
                                    if ($cid['id_estado'] == $estadoId){
                                        $selected = $cid['nome'] == $fornecedor[0]['cidade'] ? "selected" : "";
                    ...
                    <div class="form-row pt-3">
                        <div class="col-6">
                            ...
                            <input name="bairro" id="bairro" type="text" value="<?php echo $fornecedor[0]['bairro']; ?>" class="form-control" placeholder="Bairro do fornecedor...">
                        </div>
                        <div class="col-6">
                            <label class="form-label" for="username">Email: </label>
                            <input name="email" id="email" type="text" value="<?php echo $fornecedor[0]['email']; ?>" class="form-control" placeholder="Email do fornecedor...">
                        </div>
                    </div>
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div id="contasFornecedor">
                                <?php  foreach($fornecedor[0]['contas'] as $c): $timeStamp = time(); ?>
                                    <div id="contaB<?php echo $timeStamp; ?>" class="card">
                                        <div class="card-body">
                                            <h6>Nova Conta <button type="button" class="btn btn-accent float-right"
                                             onclick="removerContaFuncionario('#contaB<?php echo $timeStamp; ?>')"><i class="fa fa-trash"></i></button></h6>
                                            <div class="form-row">
                                                <div class="col-12">
                ...
                <button type="submit" class="btn btn-primary mt-3 ml-3">Atualizar Fornecedor</button>
