    ...
    <div class="col-lg-10 p-0 mx-auto">
        <div class="row">
            <div class="col-md-6 mb-24pt mb-md-0">
                <form action="<?php echo base_url(); ?>admin/modalidades/update/<?php echo $mod[0]['id']; ?>" enctype="multipart/form-data" method="POST">
                    <div class="form-group">
                        <label class="form-label" for="name">Modalidade: *</label>
                        <input id="nome" type="text" class="form-control" placeholder="Nome da modalidade" name="nome" value="<?=$mod[0]['nome']?>" required>
                    </div>

                    <button class="btn btn-primary">Atualizar Modalidade</button>
                </form>
            </div>
            <div class="col-md-6">
                <div class="card mb-0">
                    <div class="card-body">
                        <h5>Atualizar Modalidade</h5>
                            ...
                            <div class="d-flex flex-wrap align-items-start">
                                ...
                                <div class="flex" style="min-width: 180px">
                                    <small class="text-100">
                                        Edite os dados para atualizar a modalidade no sistema.
                                    </small>
                                </div>
                            </div>
                        </div>
