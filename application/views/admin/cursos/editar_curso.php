    ...
    <div class="col-lg-10 p-0 mx-auto">
        <div class="row">
            <div class="col-md-6 mb-24pt mb-md-0">
                <form action="<?php echo base_url(); ?>admin/cursos/update/<?= $cur[0]['id']; ?>" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select id="status" name="status" class="form-control" placeholder="Status do Curso" required>
                            <option value="rascunho" <?php if ($cur[0]['status'] == 'rascunho'){ echo 'selected'; } ?> >Rascunho</option>
                            <option value="ativo" <?php if ($cur[0]['status'] == 'ativo'){ echo 'selected'; } ?> >Ativo</option>
                            <option value="inativo" <?php if ($cur[0]['status'] == 'inativo'){ echo 'selected'; } ?> >Inativo</option>
                        </select>
                            ...
                            <div class="d-flex flex-wrap align-items-start">
                                ...
                                <div class="flex" style="min-width: 180px">
                                    <small class="text-100">
                                        Preencha os dados para atualizar um curso do sistema.
                                    </small>
                                </div>
                            </div>
                        </div>
