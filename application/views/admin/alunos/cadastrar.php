...
<div class="page-section border-bottom-2">
    <div class="container page__container">
        <form method="post" action="<?php echo site_url('admin/alunos/insere'); ?>" enctype="multipart/form-data" class="col-md-12 p-0 mx-auto">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-check"></i>&nbsp;&nbsp;Cadastrar Aluno</button>
            </div>
        </form>
    </div>
</div>
