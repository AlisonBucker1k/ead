            ...
            <div class="mdk-drawer-layout__content page-content d-flex justify-content-center">
                ...
                <div class="pb-32pt">
                    <div class="container page__container">
                        ...
                        <form id="recuperaForm" method="post" action="<?php echo site_url('professor/login/insere_nova_senha/'.$codigo); ?>"
                            ...
                            <div class="form-group">
                                <label class="form-label"
                                       for="password">Confirmar nova senha:</label>
                                <input name="confirma-senha" id="confirm-password"
                                       type="password"
                                       class="form-control"
                                       placeholder="Seu primeiro e ultimo nome ..." 
                                       igual="senha"
