    ...
    <div class="container page__container">
        <div class="progression-bar progression-bar--active-accent">
            ...
            <span class="progression-bar__item-text h5 mb-0 text-uppercase">
                Atualização de tarefas do curso <?= $cur[0]['id'] . ' - ' . $cur[0]['nome'] ?>
            </span>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-10 p-0 mx-auto">
        <div class="row">
            <div class="col-md-12 mb-24pt mb-md-0">
                <form id="formTarefas" action="<?php echo base_url(); ?>professor/tarefas/update/<?php echo $tarefa[0]['id'] ?>" enctype="multipart/form-data" method="POST">
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input name="ativo" id="customCheck00" type="checkbox" <?php if ($tarefa[0]['ativo'] == 1){ echo 'checked'; } ?> class="custom-control-input">
                    ...
                    <div class="form-group">
                        ...
                        <input id="nome" type="text" class="form-control" placeholder="Nome da tarefa para identificação" value="<?php echo $tarefa[0]['nome']; ?>" name="nome" required>
                    </div>
                    <br>
                    <hr>
                    <h5>Exercícios</h5>
                    <div class="card mb-4">
                        <div id="exercicios" class="card-body">
                            ...
                            <hr>
                            <?php for($i=0; $i<count($tarefa[0]['exercicios']); $i++){
                                $inputs = '';
                                $exat = $tarefa[0]['exercicios'][$i];
                                ...
                                $inputs .= '<input type="hidden" class="explicacaoAt" name="explicacao_'.$exat['id'].'" value='."'".parseHtml($exat['explicacao'])."'".' />';
                                $ind = 0;
                                $respostashtml = '';
                                ...
                                <li class="list-group-item d-flex">
                                    ...
                                    <span class="text-muted mx-12pt"></span>
                                    <div class="dropdown">
