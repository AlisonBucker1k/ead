    ...
    <div class="col-lg-10 p-0 mx-auto">
        <div class="row">
            <div class="col-md-12 mb-24pt mb-md-0">
                <form id="formprovas" action="<?php echo base_url(); ?>professor/provas/inserir/<?php echo $cur[0]['id'] ?>" enctype="multipart/form-data" method="POST">
                    ...
                    <div id="data_limite_c" class="form-group">
                        <label class="form-label" for="name">Data limite: * (data limite para fazer a prova)</label>
                        <input id="data_limite" type="data" class="form-control" placeholder="dd/mm/YYYY HH:ii" onkeyup="MascaraDataHora(this)" name="data_limite" required>
                    </div>
