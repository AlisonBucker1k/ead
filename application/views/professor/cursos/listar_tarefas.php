    ...
    <div class="container page__container">
        <div class="progression-bar progression-bar--active-accent">
            ...
            <span class="progression-bar__item-text h5 mb-0 text-uppercase">
                ...
                <a href="<?php echo site_url('professor/cursos/tarefas/cadastrar/'.$cur[0]['id'].'-'.$cur[0]['nome']); ?>">
                    <button class="btn btn-primary" onclick="openExercicio('')"><i class="fa fa-plus"></i>&nbsp;&nbsp;Cadastrar Tarefa</button>
                </a>
                <a href="<?php echo site_url('professor/cursos/editar/'.$cur[0]['id'].'-'.rawurlencode($cur[0]['nome'])); ?>">
                    <button class="btn btn-secondary"><i class="fa fa-undo"></i>&nbsp;&nbsp;Voltar ao curso</button>
                </a>
            </span>
        </div>
    </div>
                ...
                <tbody class="list" id="search">
                    <?php $totalAulas = count($usuarios);
                        foreach ($usuarios as $ent) {
                            ...
                            data-href="' . site_url('professor/cursos/tarefas/ativar/' . $ent['id']) . '"
                            ...
                            if ($ent['ativo'] == 1){
                                ...
                                $btns = '<button class="btn btn-outline-success btn-rounded" 
                                data-href="' . site_url('professor/cursos/tarefas/desativar/' . $ent['id']) . '"
                            ...
                            <td>
                                <a href="' . site_url('professor/cursos/tarefas/editar/' . $ent['id']) . '">
                                ...
                                data-href="' . site_url('professor/cursos/tarefas/remover/' . $ent['id']) . '"
