    ...
    <div class="container page__container">
        <div class="progression-bar progression-bar--active-accent">
            ...
            <span class="progression-bar__item-text h5 mb-0 text-uppercase">
                ...
                <a href="<?php echo site_url('professor/cursos/editar/'.$cur[0]['id'].'-'.rawurlencode($cur[0]['nome'])); ?>"><button class="btn btn-secondary"><i class="fa fa-undo"></i>&nbsp;&nbsp;Voltar ao curso</button></a>
            </span>
        </div>
    </div>
</div>
                ...
                <tbody class="list" id="search">
                    <?php $totalAulas = count($usuarios);
                        foreach ($usuarios as $ent) {
                            ...
                            data-href="' . site_url('professor/cursos/ativar_aula/' . $ent['id']) . '"
                            ...
                            if ($ent['ativo'] == 1){
                                ...
                                $btns = '<button class="btn btn-outline-success btn-rounded" 
                                data-href="' . site_url('professor/cursos/desativar_aula/' . $ent['id']) . '"
                        ...
                        echo  '</td>
                            ...
                            <td>
                                ...
                                data-href="' . site_url('professor/cursos/remover_aula/' . $ent['id']) . '"
