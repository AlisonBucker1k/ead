    ...
    <div class="container page__container">
        <div class="progression-bar progression-bar--active-accent">
            ...
            <span class="progression-bar__item-text h5 mb-0 text-uppercase">
                ...
                <a href="<?php echo site_url('professor/cursos/provas/cadastrar/'.$cur[0]['id'].'-'.$cur[0]['nome']); ?>">
                ...
                <tbody class="list" id="search">
                    <?php $totalAulas = count($usuarios);
                        foreach ($usuarios as $ent) {
                            ...
                            data-href="' . site_url('professor/cursos/provas/ativar/' . $ent['id']) . '"
                            ...
                            if ($ent['ativo'] == 1){
                                ...
                                $btns = '<button class="btn btn-outline-success btn-rounded" 
                                data-href="' . site_url('professor/cursos/provas/desativar/' . $ent['id']) . '"
                            ...
                            <td>
                                <a href="' . site_url('professor/cursos/provas/editar/' . $ent['id']) . '">
                                ...
                                data-href="' . site_url('professor/cursos/provas/remover/' . $ent['id']) . '"
