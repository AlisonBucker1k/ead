                ...
                <form action="<?php echo base_url();?>admin/professores/inserir" enctype="multipart/form-data" method="POST">
                    <div class="form-group">
                        ...
                        <input id="nome"
                                type="text"
                                class="form-control"
                                placeholder="Nome do Professor" name="nome">
                    </div>
                            ...
                            <div class="d-flex flex-wrap align-items-start">
                                ...
                                <div class="flex"
                                    ...
                                    <small class="text-100">
                                        Preencha os dados abaixo para inserir um novo Professor ao sistema.
                                    </small>
                                </div>
                            </div>
                        </div>
