...
<div class="page-section border-bottom-2">
    <div class="container page__container">
        <form method="post" action="<?php echo site_url('rede/dependentes/insere'); ?>" enctype="multipart/form-data" class="col-md-12 p-0 mx-auto">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">

                            <h5 class="card-title mb-4">Dados de login do dependente</h5>
                            <div class="form-group">
                                <label class="form-label" for="username">Data de Nascimento do Dependente: *</label>
                                <input name="data_nascimento" id="data_nascimento" onkeyup="MascaraData(this)" type="data" class="form-control" placeholder="DD/MM/YYYY" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-row mb-3">
                                <div class="col">
                                    ...
                                    <input name="senha" id="senhaAt" type="password" class="form-control" placeholder="*********************" required>
                                </div>
                                <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input name="email" id="email" type="email" class="form-control" placeholder="Email do dependente..." required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-4">Dados Pessoais do dependente</h5>
                            <div class="form-group">
                                <label class="form-label" for="username">Nome: *</label>
                                <input name="nome" id="nome" type="text" class="form-control" placeholder="Nome completo do dependente..." required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row pt-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input name="bairro" id="bairro" type="text" class="form-control" placeholder="Bairro do dependente..." required>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-check"></i>&nbsp;&nbsp;Cadastrar Dependente</button>
            </div>
        </form>
    </div>
</div>
