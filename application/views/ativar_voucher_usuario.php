...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.14/dist/css/bootstrap-select.min.css">
  ...
  <body>
    ...
    <main>
        <div class="container">
            <h3>ATIVAR VOUCHER USUÁRIO</h3><br/>
        <form method="post" action="<?php echo site_url('api/sending_voucher_atv'); ?>">
            ...
            <div class="form-group">
              ...
              <button type="submit" class="btn btn-block btn-danger">Ativar</button>
        </form>
        </div>
    </main><!-- /.container -->
